<x-layouts::base :title="__('Terlalu Banyak Permintaan')">
    <!-- Error 429 Section -->
    <section class="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-gray-100 flex items-center justify-center px-4 md:px-8">
        <div class="max-w-2xl mx-auto text-center">
            <!-- Large Error Code -->
            <div class="mb-8">
                <div class="text-9xl md:text-[150px] font-bold text-yellow-500 opacity-30 leading-none">
                    429
                </div>
            </div>
            ...
            <p class="text-gray-600 mb-8 max-w-md mx-auto text-lg">
                Kamu telah mengirimkan terlalu banyak permintaan dalam waktu singkat. Silakan tunggu beberapa saat dan coba lagi.
            </p>
            ...
            <div class="mt-12 text-gray-500 text-sm">
                <p>"وَالصَّابِرُونَ لَهُمْ أَجْرٌ بِغَيْرِ حِسَابٍ"</p>
                <p class="mt-2 text-xs italic">Orang-orang yang sabar akan mendapat pahala tanpa batas</p>
            </div>
        </div>
    </section>
</x-layouts::base>
